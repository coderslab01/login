...
<script>
    function modificar(cod){
      window.location="http://localhost/login/par.php?parametro="+cod;
...
<body>
	...
	?>
  <center><strong>Eliminar equipo</strong></center>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><img src="img/delete.png" onclick="modificar(<?php echo $fila["id_equipos"] ?>)"></td>
